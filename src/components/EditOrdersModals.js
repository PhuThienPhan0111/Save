...
export class EditOrdersModals extends Component{
    constructor(props){
        super(props);
    ...
    handleAdd(event){
        ...
        fetch("https://localhost:44315/api/orders", {
            ...
            body: JSON.stringify({
                order_code : event.target.Order.value,
                    ...
                    <Col sm={12}>
                        <Form onSubmit={this.handleAdd}>
                            <Form.Group controlId='Order'>
                                ...
                                <Form.Control type='text' name='Order' disabled defaultValue={this.props.order_code}/>
                            </Form.Group>
                            <Form.Group controlId='Customer'>
                                <Form.Label>Customer</Form.Label>
                                <Form.Control as='select' defaultValue={this.props.customer_code}>
                            ...
                            <Form.Group controlId='Shop'>
                                ...
                                <Form.Control as='select' onChange ={this.handleChangeShop} defaultValue={this.props.shop_code}>
                            ...
                            <Form.Group controlId='Product'>
                                ...
                                <Form.Control as='select' onChange ={this.handleChangeProduct} defaultValue={this.props.product_code}>
