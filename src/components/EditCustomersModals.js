...
export class EditCustomersModals extends Component{
    constructor(props){
        super(props);
        ...
        fetch("https://localhost:44315/api/customers", {
            ...
            headers: {
              ...
              "Content-Type":'application/json',
                ...
                body: JSON.stringify({
                    customer_code:  event.target.CustomerCode.value,
                    ...
                    <Col sm={6}>
                        <Form onSubmit={this.handleAdd}>
                            <Form.Group controlId='CustomerCode'>
                                ...
                                <Form.Control type='text' name='CustomerCode' disabled defaultValue={this.props.customer_code}/>
                            </Form.Group>
                            <Form.Group controlId='LastName'>
                                <Form.Label>Customer Last Name</Form.Label>
                                <Form.Control type='text' name='LastName' required placeholder='Nguyễn' defaultValue={this.props.last_name}/>
                            </Form.Group>
                            <Form.Group controlId='FirstName'>
                                <Form.Label>Customer First Name</Form.Label>
                                <Form.Control type='text' name='FirstName' required placeholder='Văn A' defaultValue={this.props.first_name}/>
                            </Form.Group>
                            <Form.Group controlId='BirthDay'>
                                <Form.Label>BirthDay</Form.Label>
                                <Form.Control type='text' name='BirthDay' required placeholder='01/11/1997' defaultValue={this.props.birth_day}/>
                            </Form.Group>
                            <Form.Group controlId='Email'>
                                <Form.Label>Customer Email</Form.Label>
                                <Form.Control type='text' name='Email' required placeholder='nguyenvana@email.com' defaultValue={this.props.email}/>
                            </Form.Group>
